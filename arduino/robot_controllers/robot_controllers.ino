...
char ssid[] = "MyAltice f509b2";        // your network SSID (name)
char pass[] = "4188-orange-37";    // your network password (use for WPA, or use as key for WEP), length must be 8+
